...
class LCD 
{
    ...
    **/
    ...
    @ returns: void
    **/
    void LCD_print_string(std::string word,uint8_t line, uint8_t column);

    /**
    @ Sets the location of the cursor on the LCD
    @ arguments: line(starting address), column(address offset)
    @ returns: void
    **/
    void LCD_cursor_location(uint8_t line,uint8_t column); 
